...
/** @var $this Spid_Wordpress_Public */
?>
...
<a href="#" class="italia-it-button italia-it-button-size-s button-spid" spid-idp-button="#spid-idp-button-small-get" aria-haspopup="true" aria-expanded="false">
    <span class="italia-it-button-icon"><img src="<?php $this->get_img('spid-ico-circle-bb.svg'); ?>" onerror="this.src='<?php $this->get_img('spid-ico-circle-bb.png'); ?>'; this.onerror=null;" alt="" /></span>
